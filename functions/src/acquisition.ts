    ...
    if (userAgent) {
      switch (userAgent[0]) {
        ...
        case "curl": {
          ...
          writeSensorEvent(deviceId, request.body.payload_fields);
...
function writeSensorEvent(deviceId: string, payload: object): number {
  console.log("writeSensorEvent:", deviceId, payload);
  return 1;
}
